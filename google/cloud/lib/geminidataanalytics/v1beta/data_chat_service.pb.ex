...
defmodule Google.Cloud.Geminidataanalytics.V1beta.TextMessage.TextType do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.QueryDataRequest do
  @moduledoc false
  ...
  field :context, 3,
    type: Google.Cloud.Geminidataanalytics.V1beta.QueryDataContext,
    deprecated: false

  field :generation_options, 4,
    type: Google.Cloud.Geminidataanalytics.V1beta.GenerationOptions,
    json_name: "generationOptions",
    deprecated: false
end

defmodule Google.Cloud.Geminidataanalytics.V1beta.GenerationOptions do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.QueryDataContext do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.QueryDataResponse do
  @moduledoc false
  ...
  field :query_result, 3,
    type: Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult,
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Column do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Value do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Row do
  @moduledoc false
  ...
  field :values, 1,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Value
end

defmodule Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult do
  @moduledoc false
  ...
  field :columns, 1,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Column

  field :rows, 2,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.ExecutedQueryResult.Row
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ChatRequest do
  ...
  field :client_managed_resource_context, 105,
    type: Google.Cloud.Geminidataanalytics.V1beta.ClientManagedResourceContext,
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ClientManagedResourceContext do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.SystemMessage do
  ...
  field :example_queries, 13,
    type: Google.Cloud.Geminidataanalytics.V1beta.ExampleQueries,
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.TextMessage do
  ...
  field :text_type, 2,
    type: Google.Cloud.Geminidataanalytics.V1beta.TextMessage.TextType,
    json_name: "textType",
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ExampleQueries do
  @moduledoc false
