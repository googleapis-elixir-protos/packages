...
defmodule Google.Firestore.V1.Value do
  ...
  field :field_reference_value, 19, type: :string, json_name: "fieldReferenceValue", oneof: 0

  field :function_value, 20,
    type: Google.Firestore.V1.Function,
    json_name: "functionValue",
    oneof: 0

  field :pipeline_value, 21,
    type: Google.Firestore.V1.Pipeline,
    json_name: "pipelineValue",
    oneof: 0
end
...
defmodule Google.Firestore.V1.Function.OptionsEntry do
  @moduledoc false
...
defmodule Google.Firestore.V1.Function do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :name, 1, type: :string, deprecated: false
  field :args, 2, repeated: true, type: Google.Firestore.V1.Value, deprecated: false

  field :options, 3,
    repeated: true,
    type: Google.Firestore.V1.Function.OptionsEntry,
    map: true,
    deprecated: false
end

defmodule Google.Firestore.V1.Pipeline.Stage.OptionsEntry do
  @moduledoc false
...
defmodule Google.Firestore.V1.Pipeline.Stage do
  @moduledoc false
  ...
  field :options, 3,
    repeated: true,
    type: Google.Firestore.V1.Pipeline.Stage.OptionsEntry,
    map: true,
    deprecated: false
end

defmodule Google.Firestore.V1.Pipeline do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :stages, 1, repeated: true, type: Google.Firestore.V1.Pipeline.Stage, deprecated: false
end
