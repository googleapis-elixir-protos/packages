defmodule Google.Devtools.Artifactregistry.V1.DockerImage do
  ...
  field :artifact_type, 9, type: :string, json_name: "artifactType"

  field :image_manifests, 11,
    repeated: true,
    type: Google.Devtools.Artifactregistry.V1.ImageManifest,
    json_name: "imageManifests",
    deprecated: false
end

defmodule Google.Devtools.Artifactregistry.V1.ImageManifest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :architecture, 1, type: :string, deprecated: false
  field :os, 2, type: :string, deprecated: false
  field :digest, 3, type: :string, deprecated: false
  field :media_type, 4, type: :string, json_name: "mediaType", deprecated: false
  field :os_version, 5, type: :string, json_name: "osVersion", deprecated: false
  field :os_features, 6, repeated: true, type: :string, json_name: "osFeatures", deprecated: false
  field :variant, 7, type: :string, deprecated: false
end
