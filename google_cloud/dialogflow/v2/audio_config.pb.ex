...
defmodule Google.Cloud.Dialogflow.V2.CustomPronunciationParams.PhoneticEncoding do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SynthesizeSpeechConfig do
  ...
  field :pronunciations, 6,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.CustomPronunciationParams,
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.CustomPronunciationParams do
  @moduledoc false
  ...
  field :phonetic_encoding, 2,
    type: Google.Cloud.Dialogflow.V2.CustomPronunciationParams.PhoneticEncoding,
