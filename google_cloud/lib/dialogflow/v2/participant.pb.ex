...
defmodule Google.Cloud.Dialogflow.V2.Participant.AgentDesktopSource do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :AGENT_DESKTOP_SOURCE_UNSPECIFIED, 0
  field :LIVE_PERSON, 1
  field :GENESYS_CLOUD, 2
  field :TWILIO, 3
  field :SALESFORCE, 4
  field :OTHER, 8
end
...
defmodule Google.Cloud.Dialogflow.V2.SuggestionInput.Action do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.Participant do
  ...
  field :agent_desktop_source, 10,
    type: Google.Cloud.Dialogflow.V2.Participant.AgentDesktopSource,
    json_name: "agentDesktopSource",
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Dialogflow.V2.SuggestionInput do
  ...
  field :parameters, 4, type: Google.Protobuf.Struct, deprecated: false

  field :action, 5,
    type: Google.Cloud.Dialogflow.V2.SuggestionInput.Action,
    enum: true,
    deprecated: false
