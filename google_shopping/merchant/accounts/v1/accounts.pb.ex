...
defmodule Google.Shopping.Merchant.Accounts.V1.CreateAndConfigureAccountRequest.AddUser do
  ...
  field :verification_mail_settings, 3,
    type: Google.Shopping.Merchant.Accounts.V1.VerificationMailSettings,
    json_name: "verificationMailSettings",
    deprecated: false
end
...
defmodule Google.Shopping.Merchant.Accounts.V1.CreateAndConfigureAccountRequest.AddAccountService do
  ...
  field :account_management, 104,
    type: Google.Shopping.Merchant.Accounts.V1.AccountManagement,
    json_name: "accountManagement",
    oneof: 0

  field :comparison_shopping, 105,
    type: Google.Shopping.Merchant.Accounts.V1.ComparisonShopping,
    json_name: "comparisonShopping",
    oneof: 0

  field :products_management, 106,
    type: Google.Shopping.Merchant.Accounts.V1.ProductsManagement,
    json_name: "productsManagement",
    oneof: 0

  field :campaigns_management, 107,
  ...
  field :external_account_id, 3, type: :string, json_name: "externalAccountId", deprecated: false
end

defmodule Google.Shopping.Merchant.Accounts.V1.CreateAndConfigureAccountRequest.SetAliasForRelationship do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :provider, 1, type: :string, deprecated: false
  field :account_id_alias, 2, type: :string, json_name: "accountIdAlias", deprecated: false
end
