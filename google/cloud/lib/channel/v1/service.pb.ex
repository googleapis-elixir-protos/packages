...
defmodule Google.Cloud.Channel.V1.TransferableOffer do
  ...
  field :price_reference_id, 2, type: :string, json_name: "priceReferenceId", deprecated: false
end
...
defmodule Google.Cloud.Channel.V1.ChangeOfferRequest do
  ...
  field :price_reference_id, 8, type: :string, json_name: "priceReferenceId", deprecated: false
end
...
defmodule Google.Cloud.Channel.V1.RegisterSubscriberRequest do
  ...
  field :integrator, 3, proto3_optional: true, type: :string, deprecated: false
end
...
defmodule Google.Cloud.Channel.V1.ListSubscribersRequest do
  ...
  field :page_size, 2, type: :int32, json_name: "pageSize", deprecated: false
  field :page_token, 3, type: :string, json_name: "pageToken", deprecated: false
  field :integrator, 4, proto3_optional: true, type: :string, deprecated: false
end
