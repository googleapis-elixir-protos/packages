...
defmodule Google.Spanner.Admin.Instance.V1.AutoscalingConfig.AutoscalingTargets do
  ...
  field :total_cpu_utilization_percent, 4,
    type: :int32,
    json_name: "totalCpuUtilizationPercent",
    deprecated: false
...
defmodule Google.Spanner.Admin.Instance.V1.AutoscalingConfig.AsymmetricAutoscalingOption.AutoscalingConfigOverrides do
  ...
  field :autoscaling_target_total_cpu_utilization_percent, 4,
    type: :int32,
    json_name: "autoscalingTargetTotalCpuUtilizationPercent",
    deprecated: false

  field :disable_high_priority_cpu_autoscaling, 5,
    type: :bool,
    json_name: "disableHighPriorityCpuAutoscaling",
    deprecated: false

  field :disable_total_cpu_autoscaling, 6,
    type: :bool,
    json_name: "disableTotalCpuAutoscaling",
    deprecated: false
end
