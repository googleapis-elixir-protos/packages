defmodule Google.Cloud.Aiplatform.V1beta1.FullFineTunedResources.DeploymentType do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :DEPLOYMENT_TYPE_UNSPECIFIED, 0
  field :DEPLOYMENT_TYPE_EVAL, 1
  field :DEPLOYMENT_TYPE_PROD, 2
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.MachineSpec do
  ...
  field :min_gpu_driver_version, 9,
    type: :string,
    json_name: "minGpuDriverVersion",
    deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.FullFineTunedResources do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :deployment_type, 1,
    type: Google.Cloud.Aiplatform.V1beta1.FullFineTunedResources.DeploymentType,
    json_name: "deploymentType",
    enum: true,
    deprecated: false

  field :model_inference_unit_count, 2,
    type: :int32,
    json_name: "modelInferenceUnitCount",
    deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.LustreMount do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :instance_ip, 1, type: :string, json_name: "instanceIp", deprecated: false
  field :volume_handle, 2, type: :string, json_name: "volumeHandle", deprecated: false
  field :filesystem, 3, type: :string, deprecated: false
  field :mount_point, 4, type: :string, json_name: "mountPoint", deprecated: false
end
