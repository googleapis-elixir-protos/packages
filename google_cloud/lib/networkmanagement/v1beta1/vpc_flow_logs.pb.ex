...
defmodule Google.Cloud.Networkmanagement.V1beta1.ShowEffectiveFlowLogsConfigsRequest do
  @moduledoc false
...
defmodule Google.Cloud.Networkmanagement.V1beta1.ShowEffectiveFlowLogsConfigsResponse do
  @moduledoc false
  ...
  field :effective_flow_logs_configs, 1,
    repeated: true,
    type: Google.Cloud.Networkmanagement.V1beta1.EffectiveVpcFlowLogsConfig,
