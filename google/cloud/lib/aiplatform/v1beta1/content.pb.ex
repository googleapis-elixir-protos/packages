...
defmodule Google.Cloud.Aiplatform.V1beta1.ReplicatedVoiceConfig do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.VoiceConfig do
  ...
  field :replicated_voice_config, 3,
    type: Google.Cloud.Aiplatform.V1beta1.ReplicatedVoiceConfig,
    json_name: "replicatedVoiceConfig",
    oneof: 0,
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1beta1.SpeakerVoiceConfig do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.MultiSpeakerVoiceConfig do
  @moduledoc false
  ...
  field :speaker_voice_configs, 2,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.SpeakerVoiceConfig,
...
defmodule Google.Cloud.Aiplatform.V1beta1.SpeechConfig do
  ...
  field :multi_speaker_voice_config, 3,
    type: Google.Cloud.Aiplatform.V1beta1.MultiSpeakerVoiceConfig,
