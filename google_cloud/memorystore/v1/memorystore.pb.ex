...
defmodule Google.Cloud.Memorystore.V1.EncryptionInfo.Type do
  @moduledoc false
...
defmodule Google.Cloud.Memorystore.V1.EncryptionInfo.KmsKeyState do
  @moduledoc false
...
defmodule Google.Cloud.Memorystore.V1.Instance do
  ...
  field :simulate_maintenance_event, 27,
    proto3_optional: true,
    type: :bool,
    json_name: "simulateMaintenanceEvent",
    deprecated: false
  ...
  field :satisfies_pzs, 29,
    proto3_optional: true,
    type: :bool,
    json_name: "satisfiesPzs",
    deprecated: false

  field :satisfies_pzi, 30,
    proto3_optional: true,
    type: :bool,
  ...
  field :kms_key, 45, proto3_optional: true, type: :string, json_name: "kmsKey", deprecated: false

  field :encryption_info, 46,
    type: Google.Cloud.Memorystore.V1.EncryptionInfo,
  ...
  field :maintenance_version, 49,
    proto3_optional: true,
    type: :string,
    json_name: "maintenanceVersion",
    deprecated: false

  field :effective_maintenance_version, 50,
    proto3_optional: true,
    type: :string,
    json_name: "effectiveMaintenanceVersion",
    deprecated: false

  field :available_maintenance_versions, 51,
    repeated: true,
    type: :string,
    json_name: "availableMaintenanceVersions",
    deprecated: false

  field :allow_fewer_zones_deployment, 54,
    type: :bool,
    json_name: "allowFewerZonesDeployment",
    deprecated: true
end
...
defmodule Google.Cloud.Memorystore.V1.BackupCollection do
  ...
  field :total_backup_size_bytes, 8,
    type: :int64,
    json_name: "totalBackupSizeBytes",
    deprecated: false

  field :total_backup_count, 10, type: :int64, json_name: "totalBackupCount", deprecated: false

  field :last_backup_time, 11,
    type: Google.Protobuf.Timestamp,
    json_name: "lastBackupTime",
    deprecated: false
end
...
defmodule Google.Cloud.Memorystore.V1.EncryptionInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :encryption_type, 1,
    type: Google.Cloud.Memorystore.V1.EncryptionInfo.Type,
  ...
  field :kms_key_primary_state, 3,
    type: Google.Cloud.Memorystore.V1.EncryptionInfo.KmsKeyState,
