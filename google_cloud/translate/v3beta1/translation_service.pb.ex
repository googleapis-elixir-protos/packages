...
defmodule Google.Cloud.Translation.V3beta1.BatchTranslateDocumentRequest do
  ...
  field :pdf_native_only, 13, type: :bool, json_name: "pdfNativeOnly", deprecated: false
end
...
defmodule Google.Cloud.Translation.V3beta1.RefinementEntry do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :source_text, 1, type: :string, json_name: "sourceText", deprecated: false

  field :original_translation, 2,
    type: :string,
    json_name: "originalTranslation",
    deprecated: false
end

defmodule Google.Cloud.Translation.V3beta1.RefineTextRequest do
  @moduledoc false
  ...
  field :refinement_entries, 2,
    repeated: true,
    type: Google.Cloud.Translation.V3beta1.RefinementEntry,
    json_name: "refinementEntries",
    deprecated: false
...
defmodule Google.Cloud.Translation.V3beta1.RefineTextResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :refined_translations, 1, repeated: true, type: :string, json_name: "refinedTranslations"
end
...
defmodule Google.Cloud.Translation.V3beta1.TranslationService.Service do
  ...
  rpc :RefineText,
      ...
      Google.Cloud.Translation.V3beta1.RefineTextResponse
end
