...
defmodule Google.Cloud.Networkmanagement.V1beta1.EffectiveVpcFlowLogsConfig.Scope do
  @moduledoc false
...
defmodule Google.Cloud.Networkmanagement.V1beta1.EffectiveVpcFlowLogsConfig do
  @moduledoc false
  ...
  field :scope, 12,
    proto3_optional: true,
    type: Google.Cloud.Networkmanagement.V1beta1.EffectiveVpcFlowLogsConfig.Scope,
    enum: true
end
