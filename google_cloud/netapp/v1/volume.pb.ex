...
defmodule Google.Cloud.Netapp.V1.SimpleExportPolicyRule.SquashMode do
  @moduledoc false
...
defmodule Google.Cloud.Netapp.V1.SimpleExportPolicyRule do
  ...
  field :squash_mode, 12,
    proto3_optional: true,
    type: Google.Cloud.Netapp.V1.SimpleExportPolicyRule.SquashMode,
