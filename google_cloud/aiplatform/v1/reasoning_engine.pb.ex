...
defmodule Google.Cloud.Aiplatform.V1.ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectConfig do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectSource do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :config, 1,
    type: Google.Cloud.Aiplatform.V1.ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectConfig,
    deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1.ReasoningEngineSpec.SourceCodeSpec do
  ...
  field :developer_connect_source, 3,
    type: Google.Cloud.Aiplatform.V1.ReasoningEngineSpec.SourceCodeSpec.DeveloperConnectSource,
    json_name: "developerConnectSource",
    oneof: 0
