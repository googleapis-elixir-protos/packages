defmodule Google.Shopping.Merchant.Accounts.V1.Region.RadiusArea.RadiusUnits do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :RADIUS_UNITS_UNSPECIFIED, 0
  field :MILES, 1
  field :KILOMETERS, 2
end
...
defmodule Google.Shopping.Merchant.Accounts.V1.Region.RadiusArea do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :region_code, 1, type: :string, json_name: "regionCode", deprecated: false
  field :lat_lng, 2, type: Google.Type.LatLng, json_name: "latLng", deprecated: false
  field :radius, 3, type: :double, deprecated: false

  field :radius_units, 4,
    type: Google.Shopping.Merchant.Accounts.V1.Region.RadiusArea.RadiusUnits,
...
defmodule Google.Shopping.Merchant.Accounts.V1.Region do
  ...
  field :radius_area, 7,
    type: Google.Shopping.Merchant.Accounts.V1.Region.RadiusArea,
    json_name: "radiusArea",
    deprecated: false
end
