...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Tool.Authentication.ServiceAccountAuthConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Tool.Authentication do
  ...
  field :service_account_auth_config, 5,
    type: Google.Cloud.Dialogflow.Cx.V3beta1.Tool.Authentication.ServiceAccountAuthConfig,
