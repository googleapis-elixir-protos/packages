defmodule Google.Cloud.Dialogflow.V2beta1.AgentCoachingInstruction.TriggerEvent do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2beta1.AgentCoachingInstruction do
  ...
  field :triggering_event, 10,
    type: Google.Cloud.Dialogflow.V2beta1.AgentCoachingInstruction.TriggerEvent,
