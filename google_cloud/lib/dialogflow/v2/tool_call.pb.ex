defmodule Google.Cloud.Dialogflow.V2.ToolCall.State do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.ToolCall do
  @moduledoc false
  ...
  field :state, 7, type: Google.Cloud.Dialogflow.V2.ToolCall.State, enum: true, deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.ToolCallResult.Error do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.ToolCallResult do
  @moduledoc false
  ...
  field :tool, 1, type: :string, oneof: 0, deprecated: false
  field :action, 2, type: :string, deprecated: false
  field :error, 3, type: Google.Cloud.Dialogflow.V2.ToolCallResult.Error, oneof: 1
