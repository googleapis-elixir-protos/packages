...
defmodule Google.Spanner.V1.QueryAdvisorResult.IndexAdvice do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :ddl, 1, repeated: true, type: :string, deprecated: false
  field :improvement_factor, 2, type: :double, json_name: "improvementFactor", deprecated: false
end

defmodule Google.Spanner.V1.QueryAdvisorResult do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :index_advice, 1,
    repeated: true,
    type: Google.Spanner.V1.QueryAdvisorResult.IndexAdvice,
    json_name: "indexAdvice",
    deprecated: false
end
...
defmodule Google.Spanner.V1.QueryPlan do
  ...
  field :query_advice, 2,
    type: Google.Spanner.V1.QueryAdvisorResult,
    json_name: "queryAdvice",
    deprecated: false
end
