defmodule Google.Cloud.Dialogflow.Cx.V3beta1.DetectIntentResponseView do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :DETECT_INTENT_RESPONSE_VIEW_UNSPECIFIED, 0
  field :DETECT_INTENT_RESPONSE_VIEW_FULL, 1
  field :DETECT_INTENT_RESPONSE_VIEW_BASIC, 2
end
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.DetectIntentRequest do
  ...
  field :response_view, 9,
    type: Google.Cloud.Dialogflow.Cx.V3beta1.DetectIntentResponseView,
