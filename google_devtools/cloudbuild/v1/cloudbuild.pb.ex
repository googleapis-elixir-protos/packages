...
defmodule Google.Devtools.Cloudbuild.V1.GetDefaultServiceAccountRequest do
  @moduledoc false
...
defmodule Google.Devtools.Cloudbuild.V1.DefaultServiceAccount do
  @moduledoc false
...
defmodule Google.Devtools.Cloudbuild.V1.GitSource do
  ...
  field :dir, 5, type: :string, deprecated: false
  field :revision, 6, type: :string, deprecated: false
end
...
defmodule Google.Devtools.Cloudbuild.V1.RepoSource do
  ...
  field :project_id, 1, type: :string, json_name: "projectId", deprecated: false
  field :repo_name, 2, type: :string, json_name: "repoName", deprecated: false
  ...
  field :dir, 7, type: :string, deprecated: false
  field :invert_regex, 8, type: :bool, json_name: "invertRegex", deprecated: false
...
defmodule Google.Devtools.Cloudbuild.V1.ConnectedRepository do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :repository, 1, type: :string, deprecated: false
  field :dir, 2, type: :string, deprecated: false
...
defmodule Google.Devtools.Cloudbuild.V1.Source do
  ...
  field :connected_repository, 9,
    type: Google.Devtools.Cloudbuild.V1.ConnectedRepository,
    json_name: "connectedRepository",
    oneof: 0,
    deprecated: false
end
...
defmodule Google.Devtools.Cloudbuild.V1.BuiltImage do
  ...
  field :artifact_registry_package, 5,
    type: :string,
...
defmodule Google.Devtools.Cloudbuild.V1.UploadedPythonPackage do
  ...
  field :artifact_registry_package, 4,
    type: :string,
    json_name: "artifactRegistryPackage",
    deprecated: false
end
...
defmodule Google.Devtools.Cloudbuild.V1.UploadedNpmPackage do
  ...
  field :artifact_registry_package, 7,
    type: :string,
    json_name: "artifactRegistryPackage",
    deprecated: false
end
...
defmodule Google.Devtools.Cloudbuild.V1.Build do
  ...
  field :source, 3, type: Google.Devtools.Cloudbuild.V1.Source, deprecated: false
...
defmodule Google.Devtools.Cloudbuild.V1.Artifacts.NpmPackage do
  ...
  field :repository, 1, type: :string
  field :package_path, 2, type: :string, json_name: "packagePath", deprecated: false
end
...
defmodule Google.Devtools.Cloudbuild.V1.SourceProvenance do
  ...
  field :resolved_connected_repository, 10,
    type: Google.Devtools.Cloudbuild.V1.ConnectedRepository,
    json_name: "resolvedConnectedRepository",
    deprecated: false

  field :resolved_git_source, 11,
    type: Google.Devtools.Cloudbuild.V1.GitSource,
    json_name: "resolvedGitSource",
    deprecated: false
...
defmodule Google.Devtools.Cloudbuild.V1.GitHubEnterpriseConfig do
  ...
  field :secrets, 10,
    type: Google.Devtools.Cloudbuild.V1.GitHubEnterpriseSecrets,
    deprecated: false
