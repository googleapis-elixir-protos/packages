...
defmodule Google.Cloud.Run.V2.Service.MultiRegionSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :regions, 1, repeated: true, type: :string, deprecated: false
  field :multi_region_id, 2, type: :string, json_name: "multiRegionId", deprecated: false
end
...
defmodule Google.Cloud.Run.V2.Service do
  ...
  field :iap_enabled, 25, type: :bool, json_name: "iapEnabled", deprecated: false

  field :multi_region_settings, 26,
    type: Google.Cloud.Run.V2.Service.MultiRegionSettings,
    json_name: "multiRegionSettings",
    deprecated: false
  ...
  field :threat_detection_enabled, 40,
    type: :bool,
    json_name: "threatDetectionEnabled",
    deprecated: false
