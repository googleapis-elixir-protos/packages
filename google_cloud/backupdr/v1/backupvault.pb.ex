...
defmodule Google.Cloud.Backupdr.V1.BackupVault.BackupRetentionInheritance do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :BACKUP_RETENTION_INHERITANCE_UNSPECIFIED, 0
  field :INHERIT_VAULT_RETENTION, 1
  field :MATCH_BACKUP_EXPIRE_TIME, 2
end
...
defmodule Google.Cloud.Backupdr.V1.BackupVault.EncryptionConfig do
  @moduledoc false
...
defmodule Google.Cloud.Backupdr.V1.BackupVault do
  ...
  field :backup_retention_inheritance, 27,
    proto3_optional: true,
    type: Google.Cloud.Backupdr.V1.BackupVault.BackupRetentionInheritance,
    json_name: "backupRetentionInheritance",
    enum: true,
    deprecated: false
  ...
  field :encryption_config, 29,
    proto3_optional: true,
    type: Google.Cloud.Backupdr.V1.BackupVault.EncryptionConfig,
...
defmodule Google.Cloud.Backupdr.V1.Backup do
  ...
  field :backup_retention_inheritance, 30,
    proto3_optional: true,
    type: Google.Cloud.Backupdr.V1.BackupVault.BackupRetentionInheritance,
    json_name: "backupRetentionInheritance",
    enum: true,
  ...
  field :gcp_resource, 31,
    type: Google.Cloud.Backupdr.V1.BackupGcpResource,
    json_name: "gcpResource",
    oneof: 2,
    deprecated: false

  field :kms_key_versions, 33,
    repeated: true,
    type: :string,
...
defmodule Google.Cloud.Backupdr.V1.FetchBackupsForResourceTypeRequest do
  @moduledoc false
  ...
  field :view, 7, type: Google.Cloud.Backupdr.V1.BackupView, enum: true, deprecated: false
end

defmodule Google.Cloud.Backupdr.V1.FetchBackupsForResourceTypeResponse do
  @moduledoc false
...
defmodule Google.Cloud.Backupdr.V1.RestoreBackupRequest do
  ...
  field :clear_overrides_field_mask, 8,
    proto3_optional: true,
    type: Google.Protobuf.FieldMask,
    json_name: "clearOverridesFieldMask",
    deprecated: false
end
...
defmodule Google.Cloud.Backupdr.V1.BackupGcpResource do
  @moduledoc false
