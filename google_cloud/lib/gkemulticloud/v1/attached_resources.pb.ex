...
defmodule Google.Cloud.Gkemulticloud.V1.Toleration.KeyOperator do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :KEY_OPERATOR_UNSPECIFIED, 0
  field :KEY_OPERATOR_EQUAL, 1
  field :KEY_OPERATOR_EXISTS, 2
end

defmodule Google.Cloud.Gkemulticloud.V1.Toleration.Effect do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :EFFECT_UNSPECIFIED, 0
  field :EFFECT_NO_SCHEDULE, 1
  field :EFFECT_PREFER_NO_SCHEDULE, 2
  field :EFFECT_NO_EXECUTE, 3
end
...
defmodule Google.Cloud.Gkemulticloud.V1.AttachedCluster do
  ...
  field :system_components_config, 28,
    type: Google.Cloud.Gkemulticloud.V1.SystemComponentsConfig,
    json_name: "systemComponentsConfig",
    deprecated: false
end
...
defmodule Google.Cloud.Gkemulticloud.V1.SystemComponentsConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :tolerations, 1, repeated: true, type: Google.Cloud.Gkemulticloud.V1.Toleration
  field :labels, 2, repeated: true, type: Google.Cloud.Gkemulticloud.V1.Label
end

defmodule Google.Cloud.Gkemulticloud.V1.Toleration do
  @moduledoc false
  ...
  field :key_operator, 3,
    type: Google.Cloud.Gkemulticloud.V1.Toleration.KeyOperator,
    json_name: "keyOperator",
    enum: true

  field :effect, 4, type: Google.Cloud.Gkemulticloud.V1.Toleration.Effect, enum: true
end

defmodule Google.Cloud.Gkemulticloud.V1.Label do
  @moduledoc false
