...
defmodule Google.Cloud.Run.V2.SubmitBuildRequest do
  ...
  field :machine_type, 9, type: :string, json_name: "machineType", deprecated: false

  field :release_track, 10,
    type: Google.Api.LaunchStage,
    json_name: "releaseTrack",
    enum: true,
    deprecated: false

  field :client, 11, type: :string, deprecated: false
end
