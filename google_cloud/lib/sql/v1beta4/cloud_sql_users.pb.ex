...
defmodule Google.Cloud.Sql.V1beta4.User.IamStatus do
  @moduledoc false
...
defmodule Google.Cloud.Sql.V1beta4.SqlUsersUpdateRequest do
  ...
  field :revoke_existing_roles, 6,
    proto3_optional: true,
    type: :bool,
    json_name: "revokeExistingRoles",
    deprecated: false
...
defmodule Google.Cloud.Sql.V1beta4.User do
  ...
  field :iam_status, 14,
    proto3_optional: true,
    type: Google.Cloud.Sql.V1beta4.User.IamStatus,
    json_name: "iamStatus",
    enum: true
