...
defmodule Google.Cloud.Sql.V1.ConnectSettings.MdxProtocolSupport do
  @moduledoc false
...
defmodule Google.Cloud.Sql.V1.ConnectSettings.ConnectPoolNodeConfig do
  @moduledoc false
...
defmodule Google.Cloud.Sql.V1.ConnectSettings do
  ...
  field :nodes, 64,
    repeated: true,
    type: Google.Cloud.Sql.V1.ConnectSettings.ConnectPoolNodeConfig,
    deprecated: false

  field :mdx_protocol_support, 39,
    repeated: true,
    type: Google.Cloud.Sql.V1.ConnectSettings.MdxProtocolSupport,
