defmodule Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship.Source do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship.SchemaPaths do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :left_schema_paths, 1,
    type: Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship.SchemaPaths,
  ...
  field :sources, 3,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship.Source,
    enum: true
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.Context do
  ...
  field :looker_golden_queries, 11,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.LookerGoldenQuery,
    json_name: "lookerGoldenQueries",
    deprecated: false

  field :glossary_terms, 8,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.GlossaryTerm,
    json_name: "glossaryTerms",
    deprecated: false

  field :schema_relationships, 9,
    repeated: true,
    type: Google.Cloud.Geminidataanalytics.V1beta.Context.SchemaRelationship,
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.LookerGoldenQuery do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.GlossaryTerm do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.ConversationOptions do
  ...
  field :datasource, 3,
    type: Google.Cloud.Geminidataanalytics.V1beta.DatasourceOptions,
    deprecated: false
end

defmodule Google.Cloud.Geminidataanalytics.V1beta.DatasourceOptions do
  @moduledoc false
