defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.InputDataSourceType do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.InputDataConfig.SummaryGenerationOption do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.CreateGeneratorEvaluationRequest do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GetGeneratorEvaluationRequest do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.ListGeneratorEvaluationsRequest do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.ListGeneratorEvaluationsResponse do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.DeleteGeneratorEvaluationRequest do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluation do
  @moduledoc false
  ...
  field :generator_evaluation_config, 3,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig,
  ...
  field :initial_generator, 5,
    type: Google.Cloud.Dialogflow.V2.Generator,
    json_name: "initialGenerator",
    deprecated: false

  field :summarization_metrics, 6,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics,
    json_name: "summarizationMetrics",
    oneof: 0,
    deprecated: false

  field :evaluation_status, 10,
    type: Google.Cloud.Dialogflow.V2.EvaluationStatus,
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AccuracyDecomposition do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AdherenceDecomposition do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AdherenceRubric do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.CompletenessRubric do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.Decomposition do
  @moduledoc false
  ...
  field :accuracy_decomposition, 1,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AccuracyDecomposition,
    json_name: "accuracyDecomposition",
    oneof: 0

  field :adherence_decomposition, 2,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AdherenceDecomposition,
    json_name: "adherenceDecomposition",
    oneof: 0
end

defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.EvaluationResult do
  @moduledoc false
  ...
  field :adherence_rubric, 2,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.AdherenceRubric,
    json_name: "adherenceRubric",
    oneof: 0

  field :completeness_rubric, 3,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.CompletenessRubric,
    json_name: "completenessRubric",
    oneof: 0
end

defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.SummarizationEvaluationResult do
  @moduledoc false
  ...
  field :decompositions, 7,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.Decomposition,
    deprecated: true

  field :evaluation_results, 8,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.EvaluationResult,
    json_name: "evaluationResults",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.OverallScoresByMetric do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.SectionToken do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.ConversationDetail.MetricDetail.SectionDetail do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.ConversationDetail.MetricDetail do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.ConversationDetail do
  @moduledoc false
  ...
  field :section_tokens, 3,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.SectionToken,
    json_name: "sectionTokens",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics do
  @moduledoc false
  ...
  field :summarization_evaluation_results, 4,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.SummarizationEvaluationResult,
  ...
  field :overall_metrics, 6,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.OverallScoresByMetric,
  ...
  field :conversation_details, 8,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.SummarizationEvaluationMetrics.ConversationDetail,
    json_name: "conversationDetails",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.AgentAssistInputDataConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.DatasetInputDataConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.InputDataConfig do
  @moduledoc false
  ...
  field :input_data_source_type, 1,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.InputDataSourceType,
  ...
  field :agent_assist_input_data_config, 6,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.AgentAssistInputDataConfig,
    json_name: "agentAssistInputDataConfig",
    oneof: 0

  field :dataset_input_data_config, 7,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.DatasetInputDataConfig,
    json_name: "datasetInputDataConfig",
    oneof: 0
end

defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.SummarizationConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig do
  @moduledoc false
  ...
  field :input_data_config, 1,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.InputDataConfig,
  ...
  field :summarization_config, 3,
    type: Google.Cloud.Dialogflow.V2.GeneratorEvaluationConfig.SummarizationConfig,
    json_name: "summarizationConfig",
    oneof: 0
end

defmodule Google.Cloud.Dialogflow.V2.EvaluationStatus do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluations.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.cloud.dialogflow.v2.GeneratorEvaluations",
  ...
  rpc :ListGeneratorEvaluations,
      ...
      Google.Cloud.Dialogflow.V2.ListGeneratorEvaluationsResponse
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorEvaluations.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Dialogflow.V2.GeneratorEvaluations.Service
end
