...
defmodule Google.Cloud.Networkservices.V1.LbEdgeExtension.LabelsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Networkservices.V1.LbEdgeExtension do
  @moduledoc false
  ...
  field :labels, 4,
    repeated: true,
    type: Google.Cloud.Networkservices.V1.LbEdgeExtension.LabelsEntry,
    map: true,
    deprecated: false
  ...
  field :extension_chains, 6,
    repeated: true,
    type: Google.Cloud.Networkservices.V1.ExtensionChain,
    json_name: "extensionChains",
    deprecated: false

  field :load_balancing_scheme, 7,
    type: Google.Cloud.Networkservices.V1.LoadBalancingScheme,
    json_name: "loadBalancingScheme",
    enum: true,
    deprecated: false
...
defmodule Google.Cloud.Networkservices.V1.ListLbEdgeExtensionsRequest do
  @moduledoc false
...
defmodule Google.Cloud.Networkservices.V1.ListLbEdgeExtensionsResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :lb_edge_extensions, 1,
    repeated: true,
    type: Google.Cloud.Networkservices.V1.LbEdgeExtension,
    json_name: "lbEdgeExtensions"

  field :next_page_token, 2, type: :string, json_name: "nextPageToken"
  field :unreachable, 3, repeated: true, type: :string
end

defmodule Google.Cloud.Networkservices.V1.GetLbEdgeExtensionRequest do
  @moduledoc false
...
defmodule Google.Cloud.Networkservices.V1.CreateLbEdgeExtensionRequest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :parent, 1, type: :string, deprecated: false
  field :lb_edge_extension_id, 2, type: :string, json_name: "lbEdgeExtensionId", deprecated: false

  field :lb_edge_extension, 3,
    type: Google.Cloud.Networkservices.V1.LbEdgeExtension,
    json_name: "lbEdgeExtension",
    deprecated: false

  field :request_id, 4, type: :string, json_name: "requestId", deprecated: false
end

defmodule Google.Cloud.Networkservices.V1.UpdateLbEdgeExtensionRequest do
  @moduledoc false
...
defmodule Google.Cloud.Networkservices.V1.DeleteLbEdgeExtensionRequest do
  @moduledoc false
