...
defmodule Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig.RaiCategory do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig.SensitivityLevel do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingContext do
  @moduledoc false
  ...
  field :instructions, 1,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingInstruction,
    deprecated: false
...
defmodule Google.Cloud.Dialogflow.V2.Generator do
  ...
  field :agent_coaching_context, 12,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingContext,
  ...
  field :suggestion_deduping_config, 23,
    type: Google.Cloud.Dialogflow.V2.SuggestionDedupingConfig,
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.Sources do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.DuplicateCheckResult.DuplicateSuggestion do
  @moduledoc false
  ...
  field :sources, 2,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.Sources,
    deprecated: false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.DuplicateCheckResult do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.AgentActionSuggestion do
  @moduledoc false
  ...
  field :duplicate_check_result, 3,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.DuplicateCheckResult,
    json_name: "duplicateCheckResult",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.SampleResponse do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion do
  @moduledoc false
  ...
  field :sample_responses, 3,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion.SampleResponse,
    json_name: "sampleResponses",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.GeneratorSuggestion.ToolCallInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :tool_call, 1,
    type: Google.Cloud.Dialogflow.V2.ToolCall,
    json_name: "toolCall",
    deprecated: false

  field :tool_call_result, 2,
    type: Google.Cloud.Dialogflow.V2.ToolCallResult,
...
defmodule Google.Cloud.Dialogflow.V2.GeneratorSuggestion do
  ...
  field :agent_coaching_suggestion, 3,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingSuggestion,
  ...
  field :tool_call_info, 9,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.GeneratorSuggestion.ToolCallInfo,
    json_name: "toolCallInfo",
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.SuggestionDedupingConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :category, 1,
    type: Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig.RaiCategory,
    enum: true,
    deprecated: false

  field :sensitivity_level, 2,
    type: Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig.SensitivityLevel,
    json_name: "sensitivityLevel",
    enum: true,
    deprecated: false
end

defmodule Google.Cloud.Dialogflow.V2.RaiSettings do
  @moduledoc false
  ...
  field :rai_category_configs, 1,
    repeated: true,
    type: Google.Cloud.Dialogflow.V2.RaiSettings.RaiCategoryConfig,
