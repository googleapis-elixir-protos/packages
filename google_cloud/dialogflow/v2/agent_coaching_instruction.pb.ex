defmodule Google.Cloud.Dialogflow.V2.AgentCoachingInstruction.TriggerEvent do
  @moduledoc false
  ...
  field :TOOL_CALL_COMPLETION, 5
end

defmodule Google.Cloud.Dialogflow.V2.AgentCoachingInstruction.DuplicateCheckResult.DuplicateSuggestion do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingInstruction.DuplicateCheckResult do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.V2.AgentCoachingInstruction do
  @moduledoc false
  ...
  field :duplicate_check_result, 8,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingInstruction.DuplicateCheckResult,
    json_name: "duplicateCheckResult",
    deprecated: false

  field :triggering_event, 10,
    type: Google.Cloud.Dialogflow.V2.AgentCoachingInstruction.TriggerEvent,
    json_name: "triggeringEvent",
    enum: true,
    deprecated: false
end
