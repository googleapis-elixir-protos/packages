...
defmodule Google.Cloud.Recaptchaenterprise.V1.Bot.BotType do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :BOT_TYPE_UNSPECIFIED, 0
  field :AI_AGENT, 1
  field :CONTENT_SCRAPER, 2
  field :SEARCH_INDEXER, 3
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.TokenProperties.InvalidReason do
  ...
  field :UNEXPECTED_ACTION, 7
end

defmodule Google.Cloud.Recaptchaenterprise.V1.FraudPreventionAssessment.RiskReason.Reason do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :REASON_UNSPECIFIED, 0
  field :HIGH_TRANSACTION_VELOCITY, 1
  field :EXCESSIVE_ENUMERATION_PATTERN, 2
  field :SHORT_IDENTITY_HISTORY, 3
  field :GEOLOCATION_DISCREPANCY, 4
  field :ASSOCIATED_WITH_FRAUD_CLUSTER, 5
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.IntegrationType do
  ...
  field :CHECKBOX, 2
  field :INVISIBLE, 3
  field :POLICY_BASED_CHALLENGE, 5
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.PhoneAuthenticationEvent do
  @moduledoc false
...
defmodule Google.Cloud.Recaptchaenterprise.V1.AnnotateAssessmentRequest do
  ...
  field :phone_authentication_event, 6,
    type: Google.Cloud.Recaptchaenterprise.V1.PhoneAuthenticationEvent,
    json_name: "phoneAuthenticationEvent",
    deprecated: false
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.RiskAnalysis do
  ...
  field :verified_bots, 5,
    repeated: true,
    type: Google.Cloud.Recaptchaenterprise.V1.Bot,
    json_name: "verifiedBots",
    deprecated: false
end

defmodule Google.Cloud.Recaptchaenterprise.V1.Bot do
  @moduledoc false
  ...
  field :bot_type, 2,
    type: Google.Cloud.Recaptchaenterprise.V1.Bot.BotType,
    json_name: "botType",
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.FraudPreventionAssessment.RiskReason do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :reason, 1,
    type: Google.Cloud.Recaptchaenterprise.V1.FraudPreventionAssessment.RiskReason.Reason,
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.FraudPreventionAssessment do
  ...
  field :risk_reasons, 6,
    repeated: true,
    type: Google.Cloud.Recaptchaenterprise.V1.FraudPreventionAssessment.RiskReason,
    json_name: "riskReasons",
    deprecated: false
...
defmodule Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ActionSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :score_threshold, 1, type: :float, json_name: "scoreThreshold", deprecated: false
end

defmodule Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ChallengeSettings.ActionSettingsEntry do
  @moduledoc false

  use Protobuf, map: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :key, 1, type: :string
  field :value, 2, type: Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ActionSettings
end

defmodule Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ChallengeSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :default_settings, 1,
    type: Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ActionSettings,
    json_name: "defaultSettings",
    deprecated: false

  field :action_settings, 2,
    repeated: true,
    type:
      Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ChallengeSettings.ActionSettingsEntry,
    json_name: "actionSettings",
    map: true,
    deprecated: false
end
...
defmodule Google.Cloud.Recaptchaenterprise.V1.WebKeySettings do
  ...
  field :challenge_settings, 6,
    type: Google.Cloud.Recaptchaenterprise.V1.WebKeySettings.ChallengeSettings,
    json_name: "challengeSettings",
    deprecated: false
end
