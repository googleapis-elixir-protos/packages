...
defmodule Google.Cloud.Aiplatform.V1beta1.RagVectorDbConfig.RagManagedVertexVectorSearch do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :collection_name, 1, type: :string, json_name: "collectionName", deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.RagVectorDbConfig do
  ...
  field :rag_managed_vertex_vector_search, 8,
    type: Google.Cloud.Aiplatform.V1beta1.RagVectorDbConfig.RagManagedVertexVectorSearch,
    json_name: "ragManagedVertexVectorSearch",
    oneof: 0
