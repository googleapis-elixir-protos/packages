...
defmodule Google.Cloud.Channel.V1.DiscountType do
  @moduledoc false

  use Protobuf, enum: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :DISCOUNT_TYPE_UNSPECIFIED, 0
  field :REGIONAL_DISCOUNT, 1
  field :PROMOTIONAL_DISCOUNT, 2
  field :SALES_DISCOUNT, 3
  field :RESELLER_MARGIN, 4
  field :DEAL_CODE, 5
end
...
defmodule Google.Cloud.Channel.V1.Price do
  ...
  field :price_period, 6, type: Google.Cloud.Channel.V1.Period, json_name: "pricePeriod"
  field :external_price_uri, 4, type: :string, json_name: "externalPriceUri"

  field :discount_components, 5,
    repeated: true,
    type: Google.Cloud.Channel.V1.DiscountComponent,
    json_name: "discountComponents"
end
...
defmodule Google.Cloud.Channel.V1.DiscountComponent do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  oneof :discount_value, 0

  field :discount_percentage, 3, type: :double, json_name: "discountPercentage", oneof: 0
  field :discount_absolute, 4, type: Google.Type.Money, json_name: "discountAbsolute", oneof: 0

  field :discount_type, 2,
    type: Google.Cloud.Channel.V1.DiscountType,
