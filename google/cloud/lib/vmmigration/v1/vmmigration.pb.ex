...
defmodule Google.Cloud.Vmmigration.V1.ComputeEngineTargetDefaults do
  ...
  field :adaptation_modifiers, 23,
    repeated: true,
    type: Google.Cloud.Vmmigration.V1.AdaptationModifier,
    json_name: "adaptationModifiers",
    deprecated: false
  ...
  field :storage_pool, 25, type: :string, json_name: "storagePool", deprecated: false
end

defmodule Google.Cloud.Vmmigration.V1.AdaptationModifier do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :modifier, 3, type: :string, deprecated: false
  field :value, 2, type: :string, deprecated: false
end
