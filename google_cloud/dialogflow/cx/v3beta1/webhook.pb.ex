...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Webhook.GenericWebService.ServiceAccountAuthConfig do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Webhook.GenericWebService do
  ...
  field :service_account_auth_config, 18,
    type: Google.Cloud.Dialogflow.Cx.V3beta1.Webhook.GenericWebService.ServiceAccountAuthConfig,
    json_name: "serviceAccountAuthConfig",
    deprecated: false
