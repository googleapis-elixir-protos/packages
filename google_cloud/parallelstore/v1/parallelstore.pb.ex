...
defmodule Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Uid do
  @moduledoc false
...
defmodule Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Gid do
  @moduledoc false
...
defmodule Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Mode do
  @moduledoc false
...
defmodule Google.Cloud.Parallelstore.V1.TransferMetadataOptions do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :uid, 1,
    type: Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Uid,
    enum: true,
    deprecated: false

  field :gid, 2,
    type: Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Gid,
    enum: true,
    deprecated: false

  field :mode, 3,
    type: Google.Cloud.Parallelstore.V1.TransferMetadataOptions.Mode,
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Parallelstore.V1.ImportDataRequest do
  ...
  field :metadata_options, 6,
    type: Google.Cloud.Parallelstore.V1.TransferMetadataOptions,
