...
defmodule Google.Ads.Datamanager.V1.Item do
  ...
  field :item_id, 4, type: :string, json_name: "itemId", deprecated: false

  field :additional_item_parameters, 5,
    repeated: true,
    type: Google.Ads.Datamanager.V1.ItemParameter,
    json_name: "additionalItemParameters",
    deprecated: false
end
