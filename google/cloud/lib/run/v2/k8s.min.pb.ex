...
defmodule Google.Cloud.Run.V2.Container do
  ...
  field :source_code, 17,
    type: Google.Cloud.Run.V2.SourceCode,
...
defmodule Google.Cloud.Run.V2.VolumeMount do
  ...
  field :sub_path, 4, type: :string, json_name: "subPath", deprecated: false
end
...
defmodule Google.Cloud.Run.V2.SourceCode.CloudStorageSource do
  @moduledoc false
...
defmodule Google.Cloud.Run.V2.SourceCode do
  @moduledoc false
  ...
  field :cloud_storage_source, 1,
    type: Google.Cloud.Run.V2.SourceCode.CloudStorageSource,
    json_name: "cloudStorageSource",
    oneof: 0
end
