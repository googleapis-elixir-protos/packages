...
defmodule Google.Ads.Datamanager.V1.Event do
  ...
  field :event_name, 16, type: :string, json_name: "eventName", deprecated: false
  field :client_id, 17, type: :string, json_name: "clientId", deprecated: false
  field :user_id, 18, type: :string, json_name: "userId", deprecated: false

  field :additional_event_parameters, 19,
    repeated: true,
    type: Google.Ads.Datamanager.V1.EventParameter,
    json_name: "additionalEventParameters",
    deprecated: false
end
...
defmodule Google.Ads.Datamanager.V1.EventParameter do
  @moduledoc false
