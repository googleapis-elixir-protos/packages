...
defmodule Google.Shopping.Merchant.Products.V1.ProductAttributes.ShippingBusinessDaysConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :country, 1, proto3_optional: true, type: :string
  field :business_days, 2, proto3_optional: true, type: :string, json_name: "businessDays"
end
...
defmodule Google.Shopping.Merchant.Products.V1.ProductAttributes do
  ...
  field :shipping_handling_business_days, 143,
    repeated: true,
    type: Google.Shopping.Merchant.Products.V1.ProductAttributes.ShippingBusinessDaysConfig,
    json_name: "shippingHandlingBusinessDays"

  field :shipping_transit_business_days, 144,
    repeated: true,
    type: Google.Shopping.Merchant.Products.V1.ProductAttributes.ShippingBusinessDaysConfig,
    json_name: "shippingTransitBusinessDays"

  field :handling_cutoff_times, 141,
    repeated: true,
    type: Google.Shopping.Merchant.Products.V1.HandlingCutoffTime,
    json_name: "handlingCutoffTimes"
...
defmodule Google.Shopping.Merchant.Products.V1.Shipping do
  ...
  field :handling_cutoff_time, 12,
    proto3_optional: true,
    type: :string,
    json_name: "handlingCutoffTime"

  field :handling_cutoff_timezone, 13,
    proto3_optional: true,
    type: :string,
    json_name: "handlingCutoffTimezone"
end
...
defmodule Google.Shopping.Merchant.Products.V1.HandlingCutoffTime do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :country, 1, proto3_optional: true, type: :string
  field :cutoff_time, 2, proto3_optional: true, type: :string, json_name: "cutoffTime"
  field :cutoff_timezone, 3, proto3_optional: true, type: :string, json_name: "cutoffTimezone"

  field :disable_delivery_after_cutoff, 4,
    proto3_optional: true,
    type: :bool,
    json_name: "disableDeliveryAfterCutoff"
end
