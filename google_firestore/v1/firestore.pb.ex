...
defmodule Google.Firestore.V1.ExecutePipelineRequest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  oneof :pipeline_type, 0

  oneof :consistency_selector, 1

  field :database, 1, type: :string, deprecated: false

  field :structured_pipeline, 2,
    type: Google.Firestore.V1.StructuredPipeline,
    json_name: "structuredPipeline",
    oneof: 0
...
defmodule Google.Firestore.V1.ExecutePipelineResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :transaction, 1, type: :bytes
  field :results, 2, repeated: true, type: Google.Firestore.V1.Document
  field :execution_time, 3, type: Google.Protobuf.Timestamp, json_name: "executionTime"
  field :explain_stats, 4, type: Google.Firestore.V1.ExplainStats, json_name: "explainStats"
end
...
defmodule Google.Firestore.V1.Firestore.Service do
  ...
  rpc :ExecutePipeline,
      ...
      stream(Google.Firestore.V1.ExecutePipelineResponse)
