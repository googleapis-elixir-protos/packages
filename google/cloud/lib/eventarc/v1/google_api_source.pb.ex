defmodule Google.Cloud.Eventarc.V1.GoogleApiSource.ProjectSubscriptions do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :list, 1, repeated: true, type: :string, deprecated: false
end

defmodule Google.Cloud.Eventarc.V1.GoogleApiSource.OrganizationSubscription do
  @moduledoc false
...
defmodule Google.Cloud.Eventarc.V1.GoogleApiSource do
  ...
  oneof :wide_scope_subscription, 0
  ...
  field :organization_subscription, 12,
    type: Google.Cloud.Eventarc.V1.GoogleApiSource.OrganizationSubscription,
    json_name: "organizationSubscription",
    oneof: 0,
    deprecated: false

  field :project_subscriptions, 13,
    type: Google.Cloud.Eventarc.V1.GoogleApiSource.ProjectSubscriptions,
    json_name: "projectSubscriptions",
    oneof: 0,
    deprecated: false
end
