...
defmodule Google.Cloud.Networkmanagement.V1beta1.FirewallInfo.TargetType do
  @moduledoc false
...
defmodule Google.Cloud.Networkmanagement.V1beta1.InterconnectAttachmentInfo.Type do
  @moduledoc false
...
defmodule Google.Cloud.Networkmanagement.V1beta1.Step do
  ...
  field :hybrid_subnet, 36,
    type: Google.Cloud.Networkmanagement.V1beta1.HybridSubnetInfo,
  ...
  field :interconnect_attachment, 35,
    type: Google.Cloud.Networkmanagement.V1beta1.InterconnectAttachmentInfo,
...
defmodule Google.Cloud.Networkmanagement.V1beta1.FirewallInfo do
  ...
  field :target_type, 13,
    type: Google.Cloud.Networkmanagement.V1beta1.FirewallInfo.TargetType,
...
defmodule Google.Cloud.Networkmanagement.V1beta1.HybridSubnetInfo do
  @moduledoc false
...
defmodule Google.Cloud.Networkmanagement.V1beta1.InterconnectAttachmentInfo do
  @moduledoc false
  ...
  field :type, 6,
    type: Google.Cloud.Networkmanagement.V1beta1.InterconnectAttachmentInfo.Type,
    enum: true
