...
defmodule Google.Ads.Datamanager.V1.AwsWrappedKeyInfo.KeyType do
  @moduledoc false
...
defmodule Google.Ads.Datamanager.V1.EncryptionInfo do
  ...
  field :aws_wrapped_key_info, 2,
    type: Google.Ads.Datamanager.V1.AwsWrappedKeyInfo,
    json_name: "awsWrappedKeyInfo",
    oneof: 0
end
...
defmodule Google.Ads.Datamanager.V1.AwsWrappedKeyInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :key_type, 1,
    type: Google.Ads.Datamanager.V1.AwsWrappedKeyInfo.KeyType,
    json_name: "keyType",
    enum: true,
    deprecated: false
