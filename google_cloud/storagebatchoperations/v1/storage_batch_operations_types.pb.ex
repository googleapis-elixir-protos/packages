...
defmodule Google.Cloud.Storagebatchoperations.V1.ObjectRetention.RetentionMode do
  @moduledoc false
...
defmodule Google.Cloud.Storagebatchoperations.V1.Job do
  ...
  field :dry_run, 22, type: :bool, json_name: "dryRun", deprecated: false
end
...
defmodule Google.Cloud.Storagebatchoperations.V1.ObjectRetention do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :retain_until_time, 1,
    proto3_optional: true,
    type: :string,
    json_name: "retainUntilTime",
    deprecated: false

  field :retention_mode, 2,
    proto3_optional: true,
    type: Google.Cloud.Storagebatchoperations.V1.ObjectRetention.RetentionMode,
...
defmodule Google.Cloud.Storagebatchoperations.V1.PutMetadata do
  ...
  field :object_retention, 8,
    proto3_optional: true,
    type: Google.Cloud.Storagebatchoperations.V1.ObjectRetention,
...
defmodule Google.Cloud.Storagebatchoperations.V1.Counters do
  ...
  field :total_bytes_found, 4,
    proto3_optional: true,
    type: :int64,
    json_name: "totalBytesFound",
    deprecated: false
end
