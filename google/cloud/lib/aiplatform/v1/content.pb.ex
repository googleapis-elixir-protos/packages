...
defmodule Google.Cloud.Aiplatform.V1.PrebuiltVoiceConfig do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.ReplicatedVoiceConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :mime_type, 1, type: :string, json_name: "mimeType", deprecated: false
  field :voice_sample_audio, 2, type: :bytes, json_name: "voiceSampleAudio", deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1.VoiceConfig do
  @moduledoc false
  ...
  field :prebuilt_voice_config, 1,
    type: Google.Cloud.Aiplatform.V1.PrebuiltVoiceConfig,
    json_name: "prebuiltVoiceConfig",
    oneof: 0

  field :replicated_voice_config, 3,
    type: Google.Cloud.Aiplatform.V1.ReplicatedVoiceConfig,
    json_name: "replicatedVoiceConfig",
    oneof: 0,
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1.SpeakerVoiceConfig do
  @moduledoc false
  ...
  field :voice_config, 2,
    type: Google.Cloud.Aiplatform.V1.VoiceConfig,
    json_name: "voiceConfig",
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1.MultiSpeakerVoiceConfig do
  @moduledoc false
  ...
  field :speaker_voice_configs, 2,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.SpeakerVoiceConfig,
    json_name: "speakerVoiceConfigs",
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1.SpeechConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :voice_config, 1, type: Google.Cloud.Aiplatform.V1.VoiceConfig, json_name: "voiceConfig"
  field :language_code, 2, type: :string, json_name: "languageCode", deprecated: false

  field :multi_speaker_voice_config, 3,
    type: Google.Cloud.Aiplatform.V1.MultiSpeakerVoiceConfig,
...
defmodule Google.Cloud.Aiplatform.V1.GenerationConfig do
  ...
  field :speech_config, 23,
    proto3_optional: true,
    type: Google.Cloud.Aiplatform.V1.SpeechConfig,
