...
defmodule Google.Cloud.Geminidataanalytics.V1beta.SpannerDatabaseReference.Engine do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.CloudSqlDatabaseReference.Engine do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.DatasourceReferences do
  ...
  field :alloydb, 8, type: Google.Cloud.Geminidataanalytics.V1beta.AlloyDbReference, oneof: 0

  field :spanner_reference, 9,
    type: Google.Cloud.Geminidataanalytics.V1beta.SpannerReference,
    json_name: "spannerReference",
    oneof: 0

  field :cloud_sql_reference, 10,
    type: Google.Cloud.Geminidataanalytics.V1beta.CloudSqlReference,
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.AlloyDbReference do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :database_reference, 1,
    type: Google.Cloud.Geminidataanalytics.V1beta.AlloyDbDatabaseReference,
    json_name: "databaseReference",
    deprecated: false

  field :agent_context_reference, 3,
    type: Google.Cloud.Geminidataanalytics.V1beta.AgentContextReference,
    json_name: "agentContextReference",
    deprecated: false
end

defmodule Google.Cloud.Geminidataanalytics.V1beta.AlloyDbDatabaseReference do
  @moduledoc false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.SpannerReference do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :database_reference, 1,
    type: Google.Cloud.Geminidataanalytics.V1beta.SpannerDatabaseReference,
    json_name: "databaseReference",
    deprecated: false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.SpannerDatabaseReference do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :engine, 6,
    type: Google.Cloud.Geminidataanalytics.V1beta.SpannerDatabaseReference.Engine,
    enum: true,
    deprecated: false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.CloudSqlReference do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :database_reference, 1,
    type: Google.Cloud.Geminidataanalytics.V1beta.CloudSqlDatabaseReference,
    json_name: "databaseReference",
    deprecated: false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.CloudSqlDatabaseReference do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :engine, 1,
    type: Google.Cloud.Geminidataanalytics.V1beta.CloudSqlDatabaseReference.Engine,
    enum: true,
    deprecated: false
...
defmodule Google.Cloud.Geminidataanalytics.V1beta.Datasource do
  ...
  field :alloy_db_reference, 12,
    type: Google.Cloud.Geminidataanalytics.V1beta.AlloyDbReference,
